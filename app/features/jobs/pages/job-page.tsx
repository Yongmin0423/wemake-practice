      ...
      <div className="grid grid-cols-6 -mt-20 gap-20 items-start">
        ...
        <div className="col-span-2 space-y-5 mt-32 sticky top-20 p-6 border rounded-lg">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-2xl font-medium">{loaderData.job.location}</span>
          </div>
          <div className="flex flex-col">
            <span className=" text-sm text-muted-foreground">Type</span>
            <span className="text-2xl font-medium">{loaderData.job.job_type}</span>
          </div>
          <div className="flex">
            ...
            <span className=" text-sm text-muted-foreground">35 views</span>
          </div>
